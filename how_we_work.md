...
- Architects and executes the code for the analysis.
...
- Outputs
- Where are the files?
- How to access files -- ood
- links on MSI

- What we don't do
- train
- moving files into google drive
- maintain storage space, quota
- 
...
When to ask for a GEO submission -- release date
Only used certain data to GEO


SEND US A PROJECT DESCRIPTION.
